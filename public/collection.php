...
<body>
	<div class="container">			
		...
		<article class="article">											<!-- ARTICLE -->
			...
			<script>
				window.onload=()=>{
					function loadCategory(cat, productTable){
						...
						.then(data => {
							...
							data.forEach(element => {
								...
								subcategoryDiv.onclick = () => {
									...
									function transitionToASubcategory(table) {
										fetch("/system/getSubcategory.php", {
											method: 'post',
											headers: {
												"Content-Type": "application/x-www-form-urlencoded; charset=UTF-8",
											},
											body: `subcategoryId=${subcategoryId}&table=${table}`,
										})
										.then(
									...
									transitionToASubcategory(productTable)//вводим id категории и название таблицы
								}
							})
						})
					}
